...
let storagePlanets = JSON.parse(localStorage.getItem("storagePlanets"))
if (!storagePlanets) {
    storagePlanets = new Array()
}
console.log(storagePlanets)
// Runs on page load
...
const renderPlanet = planet => {
  ...
  localStorage.setItem("planetStorage", JSON.stringify(planetStorage));
